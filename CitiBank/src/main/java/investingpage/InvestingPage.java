...
public class InvestingPage extends CommonAPI {
   ...
   /* public static void yourFinacialGoal() {
        investing.click();
        yourFinancialGoal.click();

    }
    public static void investingWithCiti() {
        investing.click();
        investingWithCiti.click();
    }*/
    public static void insightsAndTools() {
       investing.click();
